...
Write10X <- function(obj, dir) {
    ...
    if (class(obj) == "seurat") {
      # Seurat v2. Will output in cellranger2-like format
      # i.e. barcodes.tsv, genes.tsv, matrix.mtx
      ...
      # Seurat v3. Will output in cellranger3-like format
      # i.e. barcodes.tsv.gz features.tsv.gz matrix.mtx.gz
